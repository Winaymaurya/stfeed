    ...
    <>
      <Router>
        <Routes>
          ...
          {/* private pages */}
          <Route exact path="/AfterStudentLogin" element={<AfterStudentLogin />} />

          {/* techersquestions */}
          <Route exact path="/questions" element={< Teacherfeedbackquestion/>} />

          {/* Selecting teacher */}
          <Route exact path="/SelectTeacher" element={< SelectTeacher title="vinay" />} />


          {/* giving feedback */}
          <Route exact path="/Teacherfeedbackquestion" element={< Teacherfeedbackquestion />} />
